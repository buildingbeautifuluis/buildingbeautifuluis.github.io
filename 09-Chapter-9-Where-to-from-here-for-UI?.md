...
<!-- This needs another brief paragraph. Perhaps making the suggestion that science fiction is always a good way to get an idea of where things are heading. Mention Spielberg's 'Minority Report':

> [The Director's Commentary] shines a light on Minority Report's chief virtue by showing how Spielberg and his brain trust of futurists, inventors and designers created an array of technologies that anticipated real-world gadgets.
> [WIRED](https://www.wired.com/2010/04/minority-report-spielberg-futurist/)
...
We’re in **a cauldron of intense progress as we hurtle headlong into the 21st century**. It’s clear that much of what we use today, from a computing perspective, will be forever transformed as we race forwards technologically.
...
In this chapter I should emphasise that Adobe XD can be used for conversational (TK Check this.) prototyping and has powerful tools that allow you to build non-visual UIs quickly.
